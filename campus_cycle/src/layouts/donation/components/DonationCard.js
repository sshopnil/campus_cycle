          ...
          <div onClick={() => handleCardClick(card.id)} style={{ cursor: 'pointer' }}>
            ...
            >
              ...
              <CardContent>
                ...
                <ProgressBar completed={(card.progress.current / card.progress.goal) * 100} bgColor='#17c1e8' height='6px' labelSize='0px' borderRadius='8px' customLabel={card.progress.current} />
              </CardContent>
            </Card>
          </div>
        </Grid>
